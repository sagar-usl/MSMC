  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        {open && (
          <NewsItemFormBody initial={initial} onSubmit={onSubmit} onClose={() => onOpenChange(false)} />
        )}
      </DialogContent>
    </Dialog>
  );
...
interface NewsItemFormBodyProps {
  initial?: NewsItem;
  onSubmit: (input: NewsItemInput) => Promise<void>;
  onClose: () => void;
}

function NewsItemFormBody({ initial, onSubmit, onClose }: NewsItemFormBodyProps) {
